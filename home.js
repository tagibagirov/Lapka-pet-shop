...
var favoritesList = []
$(".popular").on("click", ".add-favorite", function () {
...
$(".cart").on("click", ".fa-circle-xmark", function () {
    ...
    var id = 0
    cartList.forEach((index, x) => {
        cartList.set(x, Number($(".gds .product-quantity").val()))
        id++
    })
    $(".popular .add-favorite").removeClass("fa-solid")
    $(".popular .gds").each(function () {
...
//header slide
var slideSwiper = new Swiper(".slide .mySwiper", {
    spaceBetween: 30,
    centeredSlides: true,
    loop: true,
    autoplay: {
...
// brands
var brangSwiper = new Swiper(".brands .mySwiper", {
    slidesPerView: 8,
    spaceBetween: 30,
    loop: true,
    pagination: {
...
//discount
var discountSwiper = new Swiper(".discount .mySwiper", {
    spaceBetween: 30,
    loop: true,
    centeredSlides: true,
    pagination: {
        el: ".discount .swiper-pagination",
        clickable: true,
    },
    autoplay: {
        delay: 2000,
